# Zahnarztpraxis Dr. Heinrich Schülein — Designentwurf

Designentwurf für eine neue Website der Zahnarztpraxis Dr. Heinrich Schülein,
Pfaffenstraße 27, Neubrandenburg. Nur zur Ansicht: `index.html` im Browser öffnen.
...
Texte, Angaben und Bewertungen stammen aus öffentlichen Quellen (sanego.de, Das Örtliche,
11880, DGZS, Invisalign-Anwenderverzeichnis). Die Fotos stammen aus dem Google-Unternehmensprofil der Praxis
und bleiben Eigentum der jeweiligen Urheber. Die Sprechzeiten folgen dem Praxisschild (Do 8–13 Uhr) und sind vor einer Veröffentlichung mit der Praxis abzustimmen.

Schriften: Newsreader, Jost und Herr Von Muellerhoff (für das Logo), alle unter der SIL Open Font License.
